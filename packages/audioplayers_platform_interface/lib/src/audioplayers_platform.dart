...
mixin MethodChannelAudioplayersPlatform
  ...
  @override
  Future<void> setAudioContext(String playerId, AudioContext context) {
    return _call('setAudioContext', playerId, context.toJson());
  }

  @override
  Future<void> setBalance(String playerId, double balance) {
    return _call('setBalance', playerId, <String, dynamic>{'balance': balance});
  }
  ...
  Future<void> setVolume(String playerId, double volume) {
    return _call('setVolume', playerId, <String, dynamic>{'volume': volume});
  }
  ...
  Future<void> emitLog(String playerId, String message) {
    return _call('emitLog', playerId, <String, dynamic>{'message': message});
  }
